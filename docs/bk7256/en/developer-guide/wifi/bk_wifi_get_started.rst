...
The example demo of three common BEKEN Wi-Fi usage scenarios is provided in the directory ``projects/wifi``. User can quickly learn about Wi-Fi usage based on the demo.
...
- Compile command: ``make bk7256 PROJECT=wifi/ap``
- File path: ``build/ap/bk7256/all-app.bin``
- Parameter configuratioin: ``projects/wifi/ap/main/Kconfig.projbuild``
...
- Compile command: ``make bk7256 PROJECT=wifi/scan``
- File path: ``build/scan/bk7256/all-app.bin``
- Parameter configuratioin: ``projects/wifi/scan/main/Kconfig.projbuild``
...
- Compile command: ``make bk7256 PROJECT=wifi/sta_connect``
- File path: ``build/sta_connect/bk7256/all-app.bin``
- Parameter configuratioin: ``projects/wifi/sta_connect/main/Kconfig.projbuild``
...
.. note:: The client compile command should assign appropriate PROJECT and PROJECT_LIBS ``make bk7256 PROJECT=wifi/sta_connect PROJECT_LIBS=bk7256_app``
