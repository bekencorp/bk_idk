...
- 4 当前发布的SDK版本中，上述（2，3）为方便自测试，已实现（被CONFIG_OTA_UPDATE_DEFAULT_PARTITION控制），客户需要在（projects/customization/config_ab/config/bk7258/config）将CONFIG_OTA_UPDATE_DEFAULT_PARTITION 这个宏定义关闭。
