...
- 4 In the current SDK version, the above (2,3) has been implemented (controlled by CONFIG_OTA_UPDATE_DEFAULT_PARTITION) to facilitate self-testing. Customer needs in the projects/customization/config_ab/config/bk7258/config) will shut CONFIG_OTA_UPDATE_DEFAULT_PARTITION the macro definition.
