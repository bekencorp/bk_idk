...
These files can be grouped into two categories:
  ...
  - Configuration modification file:
    ...
    - bk7239.defconfig - Default configuration for the BK7239 provided by Armino.
    - bk7239.config - BK7239 proprietary configuration in the project.
...
In the Armino project, the priority of Kconfig configuration is::
 ...
 bk7239.config > bk7239.defconfig > configuration definition files
