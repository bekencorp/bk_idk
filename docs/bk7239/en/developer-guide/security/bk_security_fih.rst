...
BK7239 provides both soft and hard protection for core security components.

Software Protection Against FIA
---------------------------------------------------------

BK7239 software prevents fault injection attacks mainly by paying attention to branch statements in BL1/BL2/TFM-S to increase random delay,
Use complex bool variables, use random memcpy/memcmp and other mechanisms to achieve.

Hardware Protection Against FIA
----------------------------------------------------

The BK7239 hardware anti-injection attack is mainly implemented by using hardware comparison at the key judgment statement of BL1. For example,
