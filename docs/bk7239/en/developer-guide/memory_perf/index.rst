...
----------------------------------------
    ...
    BK7239 as a whole has 4*128K sram, dual cores each have independent 32k dtcm and 32k itcm, 8M PSRAM


PSRAM Overview
---------------------------------------

    BK7239 chip has 8M PSRAM, and the last 1M (0x60700000~0x60800000) can be used as heap memory
 ...
 - BK7239 chip PSRAM only supports 4-byte aligned access. PSRAM must apply for memory according to WORD operation and ensure 4-byte aligned access ::
 ...
 - The low-voltage function PARAM of BK7239 chip will be powered down. 
