...
- Compile command: ``make bk7239 PROJECT=examples/wifi/ap``
- File path: ``build/ap/bk7239/all-app.bin``
...
- Compile command: ``make bk7239 PROJECT=examples/wifi/scan``
- File path: ``build/scan/bk7239/all-app.bin``
...
- Compile command: ``make bk7239 PROJECT=examples/wifi/sta_connect``
- File path: ``build/sta_connect/bk7239/all-app.bin``
...
.. note:: The client compile command should assign appropriate PROJECT and PROJECT_LIBS ``make bk7239 PROJECT=examples/wifi/sta_connect PROJECT_LIBS=bk7239_app``
