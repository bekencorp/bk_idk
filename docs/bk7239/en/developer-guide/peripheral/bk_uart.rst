...
Beken chip usually has two UARTs (UART1 and UART2). BK7239 supports three UARTs (DL_UART0, UART1 and UART2). DL_UART0 is used to print debugging information (configurable in menuconfig, default UART2)
