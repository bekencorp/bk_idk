...
+=====================+===============================+===================================================+=====+
|CONFIG_FFT           |Configure FFT function enable  |``\properties\soc\bk7239_cp1\bk7239_cp1.defconfig``|  y  |
+---------------------+-------------------------------+---------------------------------------------------+-----+
|CONFIG_FFT_TEST      |configuration demo enable      |``\properties\soc\bk7239_cp1\bk7239_cp1.defconfig``|  y  |
+---------------------+-------------------------------+---------------------------------------------------+-----+
