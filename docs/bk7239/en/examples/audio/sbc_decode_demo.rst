...
+================+=============================================+============================================+=====+
|CONFIG_SBC      |Configure whether the sbc decode take effect |``\middleware\soc\bk7239\bk7239.defconfig`` |  y  |
+----------------+---------------------------------------------+--------------------------------------------+-----+
|CONFIG_SBC_TEST |Configure whether the demo take effect       |``\middleware\soc\bk7239\bk7239.defconfig`` |  y  |
+----------------+---------------------------------------------+--------------------------------------------+-----+
