...
--------------------------------------
 ...
 - BK7239 CPU0的log通过串口uart1输出(默认波特率为115200)
 - BK7239 CPU1的log通过mailbox转发到CPU0串口uart1输出(默认波特率为115200)
 ...
 - 通过串口输入help命令查看当前支持的调试命令：
  ...
  ::
    ...
    la: bk7239:la rf_adc/fe_adc/rf_dac/fe_dac;bk7239:la rx_adc/rx_dac/tx_dac
