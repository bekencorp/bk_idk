...
BK7239使用的是Andes Technology(晶心科技)的双核CPU（D25F核），基于RISC-V指令集架构
...
-------------
 ...
 - 《AndeStar_V5_CLIC_Spec_UM205_V1.0.pdf》
    —Andes CLIC架构介绍，Armino平台7239系列产品使用PLIC架构
 ...
 - 《AndeStar_V5_PLIC_UM166_V1.3.pdf》
    —Andes PLIC架构介绍，Armino平台7239系列产品使用PLIC架构
 - 《AndeStar_V5_SPA_UM164_V1.5.pdf》
    —AndeStar系统架构和CSR文档
...
在cygwin环境执行如下命令::
    ...
    nds_ldsag.exe --version=v5 -t ./nds32_template_v5.txt bk7239_bsp.sag -o bk7239_bsp.ld
