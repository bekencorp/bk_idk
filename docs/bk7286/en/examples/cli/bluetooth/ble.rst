...
The supported CMDs are as follows:
	...
	2.AT+BLE=SETADVDATA
	 ...
	 - Test Case
		``AT+BLE=SETADVDATA,0201060909373235365f424c45,D``，in this advertising uses the AD type «Complete Local Name» ，referring to ASSIC code table，it can be seen that the Name is ``7286_BLE``.
