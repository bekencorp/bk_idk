...
+=====================+===============================+===================================================+=====+
|CONFIG_FFT           |Configure FFT function enable  |``\properties\soc\bk7286_cp1\bk7286_cp1.defconfig``|  y  |
+---------------------+-------------------------------+---------------------------------------------------+-----+
|CONFIG_FFT_TEST      |configuration demo enable      |``\properties\soc\bk7286_cp1\bk7286_cp1.defconfig``|  y  |
+---------------------+-------------------------------+---------------------------------------------------+-----+
