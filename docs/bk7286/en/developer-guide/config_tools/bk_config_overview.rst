...
Take the directory shown in the above figure as an example, projects/my_project/csv/bk7286_partitions.csv will be used as the partition table, and projects/my_project/csv/security.csv will be used as the
