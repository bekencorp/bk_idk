...
- Compile command: ``make bk7286 PROJECT=examples/wifi/ap``
- File path: ``build/ap/bk7286/all-app.bin``
...
- Compile command: ``make bk7286 PROJECT=examples/wifi/scan``
- File path: ``build/scan/bk7286/all-app.bin``
...
- Compile command: ``make bk7286 PROJECT=examples/wifi/sta_connect``
- File path: ``build/sta_connect/bk7286/all-app.bin``
...
.. note:: The client compile command should assign appropriate PROJECT and PROJECT_LIBS ``make bk7286 PROJECT=examples/wifi/sta_connect PROJECT_LIBS=bk7286_app``
