...
As shown in the figure above, BK7286 FLASH provides two access interfaces: data port and command port. In order to ensure the safety of instructions, FLASH instruction port access provides
...
.. important::
  ...
  BK7286 does not support automatic generation of random FLASH AES KEY at the moment, users need to manually configure AES KEY, in order to ensure storage in
