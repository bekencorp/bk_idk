...
This chapter takes the Hong Meng OS migration of BK7286 RISC-V architecture as an example
 ...
 - BK7286 RISC-V The mtime register is 64 bits. When adapting, you should pay attention to the definition type of the maximum value.
