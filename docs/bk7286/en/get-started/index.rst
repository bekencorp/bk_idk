...
Software：
 ...
 - GCC ARM tool chain, used to compile BK7286
...
.. note::
    ...
    1. The gitlab always has the latest Armino code, only authorised account can download the code. Please contact the your BK7286 project owner to get relevant accounts.
...
Click `Donwload <https://dl.bekencorp.com/tools/toolchain/arm/gcc-arm-none-eabi-10.3-2021.10-x86_64-linux.tar.bz2>`_ to download the BK7286 toolchain.
...
.. note::
    ...
    Tool chain the default path is configured in the middleware/soc/bk7286/bk7286.defconfig, you can modify ``CONFIG_TOOLCHAIN_PATH`` to set to your owner toolchain path:
...
Run following commands to build BK7286 verify project::

    cd ~/armino
    make bk7286 PROJECT=verify/spe

Another way to build BK7286 verify project is::
...
.. note::
    ...
    BK7286 is in developing stage, currently it only supports verify project. Please use verify project to demo BK7286.
...
We can also use the project configuration file for differentiated configuration::
    ...
    Example： bk7286.config >> bk7286.defconfig >> KConfig
    + Example of project configuration file：
        projects/app/config/bk7286.config
    + Sample chip configuration file：
        middleware/soc/bk7286/bk7286.defconfig
...
.. figure:: ../../_static/download_uart_bk7286_en.png
    :align: center
    :alt: BKFIL GUI
    :figclass: align-center
...
Currently the BK7286 use the DL_UART0 as the Log output and Cli input; You can get the supported command list through the help command.
