...
1 功能概述
-------------------------------------
	bk7286具有2路SPI控制器，对应三组SPI引脚。介绍SPI接口的cli命令使用。
...
demo运行依赖的宏配置：
	...
	+======================================+===========================+============================================+=========+
	|CONFIG_SPI_DMA                        | SPI support DMA           | ``middleware\soc\bk7286\bk7286.defconfig`` |    y    |
	+--------------------------------------+---------------------------+--------------------------------------------+---------+
	|CONFIG_SPI_SLAVE                      | support SPI slave mode    | ``middleware\soc\bk7286\bk7286.defconfig`` |    y    |
	+--------------------------------------+---------------------------+--------------------------------------------+---------+
	|CONFIG_SPI_MASTER                     | support SPI master mode   | ``middleware\soc\bk7286\bk7286.defconfig`` |    y    |
	+--------------------------------------+---------------------------+--------------------------------------------+---------+
	|CONFIG_SPI_STATIS                     | support SPI statis func   | ``middleware\soc\bk7286\bk7286.defconfig`` |    y    |
	+--------------------------------------+---------------------------+--------------------------------------------+---------+
	|CONFIG_SPI_SUPPORT_TX_FIFO_WR_READY   | support tx write ready    | ``middleware\soc\bk7286\bk7286.defconfig`` |    y    |
	+--------------------------------------+---------------------------+--------------------------------------------+---------+
...
-------------------------------------
  ...
  1、bk7286开发板在con4中将SPI引出，使用2块bk7286开发板，按照下图进行连接
