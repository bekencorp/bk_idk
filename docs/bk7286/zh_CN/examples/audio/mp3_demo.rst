...
+===========================+========================+====================================================+=====+
|CONFIG_AUDIO_MP3_TEST      |配置demo是否生效        |``\middleware\soc\bk7286\bk7286.deconfig``          |  y  |
+---------------------------+------------------------+----------------------------------------------------+-----+
|CONFIG_AUDIO               |配置audio功能是否生效   |``\middleware\soc\bk7286\bk7286.deconfig``       	  |  y  |
+---------------------------+------------------------+----------------------------------------------------+-----+
|CONFIG_AUDIO_MP3           |配置helix是否编译为库   |``\properties\soc\bk7286\bk7286.deconfig``       	  |  y  |
+---------------------------+------------------------+----------------------------------------------------+-----+
