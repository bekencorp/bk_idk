...
1) 关于DMA2D的使用指南请参考  ``html/bk7286/zh_CN/latest/examples/video/dma2d.html`` 里面详细介绍了前景图标的数据格式支持的类型，本文档就常见的ARGB8888以及RGB565的数据展开说明。
...
2.uvc摄像头的适配
	...
	1)当前暂不支持客户独立添加新的分辨率，后续会修改，因为当前增加新的分辨率需要开发人员单独给客户新的libusb.a文件，替换路径：``components/bk_libs/bk7286_app/libs/libusb.a``
