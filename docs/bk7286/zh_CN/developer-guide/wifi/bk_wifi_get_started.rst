...
- 编译命令: ``make bk7286 PROJECT=examples/wifi/ap``
- 文件路径: ``build/ap/bk7286/all-app.bin``
...
- 编译命令: ``make bk7286 PROJECT=examples/wifi/scan``
- 文件路径: ``build/scan/bk7286/all-app.bin``
...
- 编译命令: ``make bk7286 PROJECT=examples/wifi/sta_connect``
- 文件路径: ``build/sta_connect/bk7286/all-app.bin``
...
.. note:: 客户编译命令需指定相应PROJECT和PROJECT_LIBS ``make bk7286 PROJECT=examples/wifi/sta_connect PROJECT_LIBS=bk7286_app``
