...
#include "cherryusb/usb_audio.h"
#include "cherryusb/usb_video.h"
#include "cherryusb/usbh_audio.h"
#include "cherryusb/usbh_video.h"
#include "cherryusb/usb_hc.h"
#include "cherryusb/usbh_core.h"
...
{
    USB_UVC_DEVICE = 0,
//	USB_UVC_MJPEG_DEVICE = 1,
    USB_UVC_H26X_DEVICE = 1,
    USB_UAC_MIC_DEVICE = 2,
    USB_UAC_SPEAKER_DEVICE = 3,
    USB_MSD_DEVICE = 4,
    USB_OTA_DEVICE = 5,
    USB_USER_CHECK_DEVICE = 6,
	USB_CDC_DEVICE=6,
    USB_DEVICE_MAX,
} E_USB_DEVICE_T;
...
typedef enum
{
	...
	USB_HUB_PORT_8,
	USB_HUB_PORT_MAX = 8,
} E_USB_HUB_PORT_INDEX;


typedef struct
{
	E_USB_HUB_PORT_INDEX port_index;
	E_USB_DEVICE_T device_index;
	struct usbh_hubport *hport;
	void *usb_device;
	uint8_t interface_num;
	void *usb_device_param;
	void *usb_device_param_config;
} bk_usb_hub_port_info;
