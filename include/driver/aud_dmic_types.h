...
#define BK_ERR_AUD_DMIC_BASE                (BK_ERR_AUD_BASE - 20)
#define BK_ERR_AUD_DMIC_NOT_INIT			(BK_ERR_AUD_DMIC_BASE - 1) /**< AUD driver not init */
...
typedef enum {
	AUD_DMIC_CHL_L,    /**< enable dac left channel */
...
typedef struct {
	aud_dmic_chl_t dmic_chl;                          /**< AUD adc sample rate */
