...
#define BK_ERR_AUD_DAC_BASE                (BK_ERR_AUD_BASE - 30)
#define BK_ERR_AUD_DAC_NOT_INIT			(BK_ERR_AUD_DAC_BASE - 1) /**< AUD driver not init */
...
typedef enum {
	AUD_DAC_CHL_L,    /**< enable dac left channel */
