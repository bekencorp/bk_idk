...
* Class specific
*/
#define MUSB_DESC_TYPE_CS_INTERFACE      0x24
#define MUSB_DESC_TYPE_CS_ENDPOINT       0x25
...
typedef struct
{
    ...
    uint16_t wIndex;
    uint16_t wLength;
	uint8_t buffervalue1;
	uint8_t buffervalue2;
	uint8_t buffervalue3;
} __attribute__ ((packed))   MUSB_DeviceRequestUAC;
