...
void ethermind_bt_mesh_subnet_callback(struct bt_mesh_subnet_cb *param, void *arg1, void *arg2, void *arg3, void *arg4)
{
	struct bt_mesh_subnet *sub = (typeof(sub))arg1;
	enum bt_mesh_key_evt evt = (typeof(evt))arg2;

	param->evt_handler(sub, evt);
}
#endif
...
{
#if CONFIG_ACLSEMI_BTC_FEATURE_INCLUDED
	extern void mesh_foreach_bt_mesh_subnet_cb(void (*cb)(struct bt_mesh_subnet_cb *param, void *arg1, void *arg2, void *arg3, void *arg4),
					void *arg1, void *arg2, void *arg3, void *arg4);
	mesh_foreach_bt_mesh_subnet_cb(ethermind_bt_mesh_subnet_callback, sub, (void *)evt, NULL, NULL);
#else
