...
extern void mesh_foreach_bt_mesh_lpn_cb(void (*cb)(struct bt_mesh_lpn_cb *param, void *arg1, void *arg2, void *arg3, void *arg4),
        void *arg1, void *arg2, void *arg3, void *arg4);

void ethermind_bt_mesh_lpn_clear_friendship_callback(struct bt_mesh_lpn_cb *param, void *arg1, void *arg2, void *arg3, void *arg4)
{
	if (param->terminated && bt_mesh.lpn.frnd != BT_MESH_ADDR_UNASSIGNED)
	{
		param->terminated(bt_mesh.lpn.sub->net_idx, bt_mesh.lpn.frnd);
	}
}

void ethermind_bt_mesh_lpn_req_sent_callback(struct bt_mesh_lpn_cb *param, void *arg1, void *arg2, void *arg3, void *arg4)
{
	if (param->polled)
	{
		param->polled(bt_mesh.lpn.sub->net_idx, bt_mesh.lpn.frnd, !!(bt_mesh.lpn.req_attempts));
	}
}

void ethermind_bt_mesh_lpn_friend_update_callback(struct bt_mesh_lpn_cb *param, void *arg1, void *arg2, void *arg3, void *arg4)
{
	if (param->established)
	{
		param->established(bt_mesh.lpn.sub->net_idx, bt_mesh.lpn.frnd, bt_mesh.lpn.queue_size, bt_mesh.lpn.recv_win);
	}
}
...
#if CONFIG_ACLSEMI_BTC_FEATURE_INCLUDED
	mesh_foreach_bt_mesh_lpn_cb(ethermind_bt_mesh_lpn_clear_friendship_callback, NULL, NULL, NULL, NULL);
#else
...
#if CONFIG_ACLSEMI_BTC_FEATURE_INCLUDED
	mesh_foreach_bt_mesh_lpn_cb(ethermind_bt_mesh_lpn_req_sent_callback, NULL, NULL, NULL, NULL);
#else
	STRUCT_SECTION_FOREACH(bt_mesh_lpn_cb, cb) {
		if (cb->polled) {
			      ...
			      struct net_buf_simple *buf)
{
	...
	if (!lpn->established) {
		...
		bt_mesh_hb_feature_changed(BT_MESH_FEAT_LOW_POWER);
#if CONFIG_ACLSEMI_BTC_FEATURE_INCLUDED
		mesh_foreach_bt_mesh_lpn_cb(ethermind_bt_mesh_lpn_friend_update_callback, NULL, NULL, NULL, NULL);
#else
		STRUCT_SECTION_FOREACH(bt_mesh_lpn_cb, cb) {
			if (cb->established) {
