...
void ethermind_bt_mesh_app_key_callback(struct bt_mesh_app_key_cb *param, void *arg1, void *arg2, void *arg3, void *arg4)
{
	struct app_key *app = (typeof(app))arg1;
	uint32_t evt = (typeof(evt))arg2;

	param->evt_handler(app->app_idx, app->net_idx, evt);
}
#endif
...
{
#if CONFIG_ACLSEMI_BTC_FEATURE_INCLUDED
	extern void mesh_foreach_bt_mesh_app_key_cb(void (*cb)(struct bt_mesh_app_key_cb *param, void *arg1, void *arg2, void *arg3, void *arg4),
			void *arg1, void *arg2, void *arg3, void *arg4);
	mesh_foreach_bt_mesh_app_key_cb(ethermind_bt_mesh_app_key_callback, app, (void *)evt, NULL, NULL);
#else
