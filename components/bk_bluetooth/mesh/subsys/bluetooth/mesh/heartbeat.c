...
extern void mesh_foreach_bt_mesh_hb_cb(void (*cb)(struct bt_mesh_hb_cb *param, void *arg1, void *arg2, void *arg3, void *arg4),
		void *arg1, void *arg2, void *arg3, void *arg4);

void ethermind_bt_mesh_hb_recv_callback(struct bt_mesh_hb_cb *param, void *arg1, void *arg2, void *arg3, void *arg4)
{
	uint8_t hops = (typeof(hops))(size_t)arg1;
	uint8_t feat = (typeof(feat))(size_t)arg2;

	if (param->recv)
	{
		param->recv(&sub, hops, feat);
	}
}

void ethermind_bt_mesh_hb_sub_end_callback(struct bt_mesh_hb_cb *param, void *arg1, void *arg2, void *arg3, void *arg4)
{
	if (param->sub_end)
	{
		param->sub_end(&sub);
...
#if CONFIG_ACLSEMI_BTC_FEATURE_INCLUDED
	mesh_foreach_bt_mesh_hb_cb(ethermind_bt_mesh_hb_recv_callback, (void *)(size_t)hops, (void *)(size_t)feat, NULL, NULL);
#else
...
static void notify_sub_end(void)
{
	sub.remaining = 0;
#if CONFIG_ACLSEMI_BTC_FEATURE_INCLUDED
	mesh_foreach_bt_mesh_hb_cb(ethermind_bt_mesh_hb_sub_end_callback, NULL, NULL, NULL, NULL);
#else
	STRUCT_SECTION_FOREACH(bt_mesh_hb_cb, cb) {
		if (cb->sub_end) {
			cb->sub_end(&sub);
