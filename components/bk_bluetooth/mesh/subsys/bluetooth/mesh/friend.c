...
void ethermind_bt_mesh_friend_terminated_callback(struct bt_mesh_friend_cb *param, void *arg1, void *arg2, void *arg3, void *arg4)
{
	struct bt_mesh_friend *frnd = (typeof(frnd))arg1;
	if (frnd->established && param->terminated)
	{
		param->terminated(frnd->subnet->net_idx, frnd->lpn);
	}
}
#endif
...
#if CONFIG_ACLSEMI_BTC_FEATURE_INCLUDED
	extern void mesh_foreach_bt_mesh_friend_cb(void (*cb)(struct bt_mesh_friend_cb *param, void *arg1, void *arg2, void *arg3, void *arg4), void *arg1, void *arg2, void *arg3, void *arg4);
	mesh_foreach_bt_mesh_friend_cb(ethermind_bt_mesh_friend_terminated_callback, frnd, NULL, NULL, NULL);
#else
...
#if CONFIG_ACLSEMI_BTC_FEATURE_INCLUDED
void ethermind_bt_mesh_friend_polled_callback(struct bt_mesh_friend_cb *param, void *arg1, void *arg2, void *arg3, void *arg4)
{
    struct bt_mesh_friend *frnd = (typeof(frnd))arg1;

    if (param->polled)
    {
        param->polled(frnd->subnet->net_idx, frnd->lpn);
    }
}

void ethermind_bt_mesh_friend_established_callback(struct bt_mesh_friend_cb *param, void *arg1, void *arg2, void *arg3, void *arg4)
{
    struct bt_mesh_friend *frnd = (typeof(frnd))arg1;

    if (param->established)
    {
        param->established(frnd->subnet->net_idx, frnd->lpn, frnd->recv_delay, frnd->poll_to);
    }
}
...
#if CONFIG_ACLSEMI_BTC_FEATURE_INCLUDED
    extern void mesh_foreach_bt_mesh_friend_cb(void (*cb)(struct bt_mesh_friend_cb *param, void *arg1, void *arg2, void *arg3, void *arg4), void *arg1, void *arg2, void *arg3, void *arg4);
    mesh_foreach_bt_mesh_friend_cb(ethermind_bt_mesh_friend_polled_callback, frnd, NULL, NULL, NULL);
#else
...
#if CONFIG_ACLSEMI_BTC_FEATURE_INCLUDED
        extern void mesh_foreach_bt_mesh_friend_cb(void (*cb)(struct bt_mesh_friend_cb *param, void *arg1, void *arg2, void *arg3, void *arg4), void *arg1, void *arg2, void *arg3, void *arg4);
        mesh_foreach_bt_mesh_friend_cb(ethermind_bt_mesh_friend_established_callback, frnd, NULL, NULL, NULL);
#else
