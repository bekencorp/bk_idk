# release/v2.0.1 分支进入维护阶段，不再添加新功能。release/v2.0.2 分支目前处于新功能开发阶段
...
|:------------ |:---------------:  |:---------------: |:-----------------:    |:-----------------:   |:----------------------: |
|main          |                   |                  |                       |                      |          无             |
|release/v2.0.1|                   |                  |           [维护阶段]   |            [维护阶段] |维护阶段                 |
|release/v2.0.2|                   |                  |      [新功能开发阶段]   |      [新功能开发阶段] |新功能开发阶段           |
