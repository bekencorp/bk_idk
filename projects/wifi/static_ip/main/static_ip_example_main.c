...
#define EXAMPLE_STATIC_IP            CONFIG_EXAMPLE_STATIC_IP
#define EXAMPLE_STATIC_NETMASK       CONFIG_EXAMPLE_STATIC_NETMASK
#define EXAMPLE_STATIC_GW            CONFIG_EXAMPLE_STATIC_GW
#define EXAMPLE_STATIC_DNS           CONFIG_EXAMPLE_STATIC_DNS
...
{
	netif_ip4_config_t example_static_ip4_config = {
		.ip = EXAMPLE_STATIC_IP,
		.mask = EXAMPLE_STATIC_NETMASK,
		.gateway = EXAMPLE_STATIC_GW,
		.dns = EXAMPLE_STATIC_DNS,
	};

	wifi_init_config_t wifi_config = WIFI_DEFAULT_INIT_CONFIG();

	BK_LOG_ON_ERR(bk_netif_static_ip(example_static_ip4_config));
