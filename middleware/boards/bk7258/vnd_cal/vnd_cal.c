...
const TXPWR_ST gtxpwr_tab_def_g[WLAN_2_4_G_CHANNEL_NUM] = {
    ...
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),  // ch10
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),
...
const TXPWR_ST gtxpwr_tab_def_n_40[WLAN_2_4_G_CHANNEL_NUM] = {
    ...
    INIT_TXPWR_VALUE(40, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(40, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(40, TXPWR_ELEM_UNUSED),  // ch11
    INIT_TXPWR_VALUE(40, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(40, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(40, TXPWR_ELEM_UNUSED),
};
...
const TXPWR_ST gtxpwr_tab_def_ble[BLE_2_4_G_CHANNEL_NUM] = {
    ...
    INIT_TXPWR_VALUE(53, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(53, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_INUSED),  // ch19 2440 inused
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),  // ch24 2450
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),  // ch29 2460
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),  // ch34 2470
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_UNUSED),  // ch39 2480 inused
};
