...
const TXPWR_ST gtxpwr_tab_def_n_40[WLAN_2_4_G_CHANNEL_NUM] = {
    ...
    INIT_TXPWR_VALUE(49, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(49, TXPWR_ELEM_UNUSED),  // ch3
    INIT_TXPWR_VALUE(49, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(49, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(49, TXPWR_ELEM_UNUSED),
    ...
    INIT_TXPWR_VALUE(48, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(48, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(47, TXPWR_ELEM_UNUSED),  // ch11
    INIT_TXPWR_VALUE(47, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(47, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(47, TXPWR_ELEM_UNUSED),
};
...
const TXPWR_ST gtxpwr_tab_def_ble[BLE_2_4_G_CHANNEL_NUM] = {
    INIT_TXPWR_VALUE(54, TXPWR_ELEM_UNUSED),  // ch0 2402  inused
    INIT_TXPWR_VALUE(54, TXPWR_ELEM_UNUSED),  // ch1 2404
    INIT_TXPWR_VALUE(54, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(54, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(54, TXPWR_ELEM_UNUSED),  // ch4 2410
    INIT_TXPWR_VALUE(54, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(54, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(54, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(54, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(54, TXPWR_ELEM_UNUSED),  // ch9 2420
    INIT_TXPWR_VALUE(53, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(53, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(53, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(53, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(53, TXPWR_ELEM_UNUSED),  // ch14 2430
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(52, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_INUSED),  // ch19 2440 inused
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_UNUSED),  // ch24 2450
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(51, TXPWR_ELEM_UNUSED),  // ch29 2460
    INIT_TXPWR_VALUE(50, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(50, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(50, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(50, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(50, TXPWR_ELEM_UNUSED),  // ch34 2470
    INIT_TXPWR_VALUE(50, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(50, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(50, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(50, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(49, TXPWR_ELEM_UNUSED),  // ch39 2480 inused
};
...
void vnd_cal_overlay(void)
{
    ...
    //EPA
#if EPA_ENABLE_FLAG
    vnd_cal_set_epa_config(1, GPIO_22, GPIO_21, pwr_gain_base_gain_b, pwr_gain_base_gain_g);
#else
    vnd_cal_set_epa_config(0, GPIO_22, GPIO_21, pwr_gain_base_gain_b, pwr_gain_base_gain_g);
#endif
}
