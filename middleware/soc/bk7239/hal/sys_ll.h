...
static inline void sys_ll_set_cpu_26m_wdt_clk_div_clksel_auxs_cis(uint32_t v) {
	sys_cpu_26m_wdt_clk_div_t *r = (sys_cpu_26m_wdt_clk_div_t*)(SOC_SYS_REG_BASE + (0xa << 2));
	r->clksel_auxs_cis = v;
}

static inline uint32_t sys_ll_get_cpu_26m_wdt_clk_div_clksel_auxs_cis(void) {
	sys_cpu_26m_wdt_clk_div_t *r = (sys_cpu_26m_wdt_clk_div_t*)(SOC_SYS_REG_BASE + (0xa << 2));
	return r->clksel_auxs_cis;
}
...
static inline void sys_ll_set_reserver_reg0xd_src_cken(uint32_t v) {
	sys_reserver_reg0xd_t *r = (sys_reserver_reg0xd_t*)(SOC_SYS_REG_BASE + (0xd << 2));
	r->src_cken = v;
}

static inline uint32_t sys_ll_get_reserver_reg0xd_src_cken(void) {
	sys_reserver_reg0xd_t *r = (sys_reserver_reg0xd_t*)(SOC_SYS_REG_BASE + (0xd << 2));
	return r->src_cken;
}
...
static inline void sys_ll_set_reserver_reg0xd_reserved_bit_8(uint32_t v) {
	sys_reserver_reg0xd_t *r = (sys_reserver_reg0xd_t*)(SOC_SYS_REG_BASE + (0xd << 2));
	r->reserved_bit_8 = v;
}

static inline uint32_t sys_ll_get_reserver_reg0xd_reserved_bit_8(void) {
	sys_reserver_reg0xd_t *r = (sys_reserver_reg0xd_t*)(SOC_SYS_REG_BASE + (0xd << 2));
	return r->reserved_bit_8;
}
