...
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_CLK_CONTROL);
	reg_value &= ~(ADC_SOFT_RESET_MASK << ADC_SOFT_RESET_POSI);
	reg_value |= ((value & ADC_SOFT_RESET_MASK) << ADC_SOFT_RESET_POSI);
	REG_WRITE(AUD_CLK_CONTROL,reg_value);
}
...
static inline void aud_ll_set_fifo_config_dmic_int_en(uint32_t value)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_FIFO_CONFIG);
	reg_value &= ~(DMIC_INT_EN_MASK << DMIC_INT_EN_POSI);
	reg_value |= ((value & DMIC_INT_EN_MASK) << DMIC_INT_EN_POSI);
	REG_WRITE(AUD_FIFO_CONFIG,reg_value);
}
...
static inline uint32_t aud_ll_get_fifo_config_dmic_int_en(void)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_FIFO_CONFIG);
	reg_value = ((reg_value >> DMIC_INT_EN_POSI) & DMIC_INT_EN_MASK);
	return reg_value;
}
...
static inline void aud_ll_set_fifo_config_dmic_wr_threshold(uint32_t value)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_FIFO_CONFIG);
	reg_value &= ~(DMIC_WR_THRED_MASK << DMIC_WR_THRED_POSI);
	reg_value |= ((value & DMIC_WR_THRED_MASK) << DMIC_WR_THRED_POSI);
	REG_WRITE(AUD_FIFO_CONFIG,reg_value);
}
...
static inline uint32_t aud_ll_get_fifo_config_dmic_wr_threshold(void)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_FIFO_CONFIG);
	reg_value = ((reg_value >> DMIC_WR_THRED_POSI) & DMIC_WR_THRED_MASK);
	return reg_value;
}
...
static inline uint32_t aud_ll_get_fifo_config_loop_dmic2dac(void)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_FIFO_CONFIG);
	reg_value = ((reg_value >> LOOP_DMIC2DAC_POSI) & LOOP_DMIC2DAC_MASK);
	return reg_value;
}
...
static inline void aud_ll_set_fifo_config_loop_dmic2dac(uint32_t value)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_FIFO_CONFIG);
	reg_value &= ~(LOOP_DMIC2DAC_MASK << LOOP_DMIC2DAC_POSI);
	reg_value |= ((value & LOOP_DMIC2DAC_MASK) << LOOP_DMIC2DAC_POSI);
	REG_WRITE(AUD_FIFO_CONFIG,reg_value);
}
...
static inline uint32_t aud_ll_get_fifo_status_dmic_int_flag(void)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_FIFO_STATUS);
	reg_value = ((reg_value >> DMIC_INT_FLAG_POSI) & DMIC_INT_FLAG_MASK);
	return reg_value;
}
...
static inline uint32_t aud_ll_get_fifo_status_dmic_fifo_empty(void)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_FIFO_STATUS);
	reg_value = ((reg_value >> DMIC_FIFO_EMPTY_POSI) & DMIC_FIFO_EMPTY_MASK);
	return reg_value;
}
...
static inline uint32_t aud_ll_get_fifo_status_dmic_fifo_full(void)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_FIFO_STATUS);
	reg_value = ((reg_value >> DMIC_FIFO_FULL_POSI) & DMIC_FIFO_FULL_MASK);
	return reg_value;
}
...
static inline uint32_t aud_ll_get_fifo_status_dmic_near_empty(void)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_FIFO_STATUS);
	reg_value = ((reg_value >> DMIC_NEAR_EMPTY_POSI) & DMIC_NEAR_EMPTY_MASK);
	return reg_value;
}
...
static inline uint32_t aud_ll_get_fifo_status_dmic_near_full(void)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_FIFO_STATUS);
	reg_value = ((reg_value >> DMIC_NEAR_FULL_POSI) & DMIC_NEAR_FULL_MASK);
	return reg_value;
}

static inline uint32_t aud_ll_get_mic_fport_dmic_l_value(void)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_DMIC_FIFO_PORT);
	reg_value = ((reg_value >> AD_DMIC_L_FIFO_POSI) & AD_DMIC_L_FIFO_MASK);
	return reg_value;
}

static inline uint32_t aud_ll_get_mic_fport_dmic_r_value(void)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_DMIC_FIFO_PORT);
	reg_value = ((reg_value >> AD_DMIC_R_FIFO_POSI) & AD_DMIC_R_FIFO_MASK);
	return reg_value;
}
...
static inline uint32_t aud_ll_get_audio_config_dig_mic_div(void)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_CONFIG);
	reg_value = ((reg_value >> DIG_MIC_DIV_POSI) & DIG_MIC_DIV_MASK);
	return reg_value;
}
...
static inline void aud_ll_set_audio_config_dig_mic_div(uint32_t value)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_CONFIG);
	reg_value &= ~(DIG_MIC_DIV_MASK << DIG_MIC_DIV_POSI);
	reg_value |= ((value & DIG_MIC_DIV_MASK) << DIG_MIC_DIV_POSI);
	REG_WRITE(AUD_CONFIG,reg_value);
}
...
static inline uint32_t aud_ll_get_audio_config_dmic_cic_sel(void)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_CONFIG);
	reg_value = ((reg_value >> DMIC_CIC_SEL_POSI) & DMIC_CIC_SEL_MASK);
	return reg_value;
}
...
static inline void aud_ll_set_audio_config_dmic_cic_sel(uint32_t value)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_CONFIG);
	reg_value &= ~(DMIC_CIC_SEL_MASK << DMIC_CIC_SEL_POSI);
	reg_value |= ((value & DMIC_CIC_SEL_MASK) << DMIC_CIC_SEL_POSI);
	REG_WRITE(AUD_CONFIG,reg_value);
}
...
static inline uint32_t aud_ll_get_audio_config_dmic_enable(void)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_CONFIG);
	reg_value = ((reg_value >> DMIC_ENABLE_POSI) & DMIC_ENABLE_MASK);
	return reg_value;
}
...
static inline void aud_ll_set_audio_config_dmic_enable(uint32_t value)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_CONFIG);
	reg_value &= ~(DMIC_ENABLE_MASK << DMIC_ENABLE_POSI);
	reg_value |= ((value & DMIC_ENABLE_MASK) << DMIC_ENABLE_POSI);
	REG_WRITE(AUD_CONFIG,reg_value);
}
...
static inline uint32_t aud_ll_get_audio_config_apll_sel(void)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_CONFIG);
	reg_value = ((reg_value >> APLL_SEL_POSI) & APLL_SEL_MASK);
	return reg_value;
}
...
static inline void aud_ll_set_audio_config_apll_sel(uint32_t value)
{
	uint32_t reg_value;
	reg_value = REG_READ(AUD_CONFIG);
	reg_value &= ~(APLL_SEL_MASK << APLL_SEL_POSI);
	reg_value |= ((value & APLL_SEL_MASK) << APLL_SEL_POSI);
	REG_WRITE(AUD_CONFIG,reg_value);
}
