...
#define PWM_LL_REG_BASE(id)      (SOC_PWM_REG_BASE + (id * PWM_LL_REG_BASE_OFFSET))
...
/* REG_0x2F */
#define PWM_CR3_ADDR  (0x2F*4) //REG ADDR :0x802bbc
#define PWM_CR3_CCRAIE_POS (0)
#define PWM_CR3_CCRAIE_MASK (0x1)

#define PWM_CR3_CCRBIE_POS (1)
#define PWM_CR3_CCRBIE_MASK (0x1)

#define PWM_CR3_CCRCIE_POS (2)
#define PWM_CR3_CCRCIE_MASK (0x1)

#define PWM_CR3_CHAE_POS (3)
#define PWM_CR3_CHAE_MASK (0x1)

#define PWM_CR3_CHBE_POS (4)
#define PWM_CR3_CHBE_MASK (0x1)

#define PWM_CR3_CHCE_POS (5)
#define PWM_CR3_CHCE_MASK (0x1)

#define PWM_CR3_CCAIF_POS (6)
#define PWM_CR3_CCAIF_MASK (0x1)

#define PWM_CR3_CCBIF_POS (7)
#define PWM_CR3_CCBIF_MASK (0x1)

#define PWM_CR3_CCCIF_POS (8)
#define PWM_CR3_CCCIF_MASK (0x1)

#define PWM_CR3_CEN6_POS (9)
#define PWM_CR3_CEN6_MASK (0x1)

#define PWM_CR3_CEN5_POS (10)
#define PWM_CR3_CEN5_MASK (0x1)

#define PWM_CR3_CEN4_POS (11)
#define PWM_CR3_CEN4_MASK (0x1)

static inline void pwm_ll_set_cr3_ccraie_value(pwm_hw_id_t id, uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value &= ~(PWM_CR3_CCRAIE_MASK << PWM_CR3_CCRAIE_POS);
    reg_value |= ((value & PWM_CR3_CCRAIE_MASK) << PWM_CR3_CCRAIE_POS);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR,reg_value);
}

static inline uint32_t pwm_ll_get_cr3_ccraie(pwm_hw_id_t id)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value = ((reg_value >> PWM_CR3_CCRAIE_POS) & PWM_CR3_CCRAIE_MASK);
    return reg_value;
}

static inline void pwm_ll_set_cr3_ccrbie_value(pwm_hw_id_t id, uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value &= ~(PWM_CR3_CCRBIE_MASK << PWM_CR3_CCRBIE_POS);
    reg_value |= ((value & PWM_CR3_CCRBIE_MASK) << PWM_CR3_CCRBIE_POS);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR,reg_value);
}

static inline uint32_t pwm_ll_get_cr3_ccrbie(pwm_hw_id_t id)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value = ((reg_value >> PWM_CR3_CCRBIE_POS) & PWM_CR3_CCRBIE_MASK);
    return reg_value;
}

static inline void pwm_ll_set_cr3_ccrcie_value(pwm_hw_id_t id, uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value &= ~(PWM_CR3_CCRCIE_MASK << PWM_CR3_CCRCIE_POS);
    reg_value |= ((value & PWM_CR3_CCRCIE_MASK) << PWM_CR3_CCRCIE_POS);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR,reg_value);
}

static inline uint32_t pwm_ll_get_cr3_ccrcie(pwm_hw_id_t id)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value = ((reg_value >> PWM_CR3_CCRCIE_POS) & PWM_CR3_CCRCIE_MASK);
    return reg_value;
}

static inline void pwm_ll_set_cr3_chae_value(pwm_hw_id_t id, uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value &= ~(PWM_CR3_CHAE_MASK << PWM_CR3_CHAE_POS);
    reg_value |= ((value & PWM_CR3_CHAE_MASK) << PWM_CR3_CHAE_POS);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR,reg_value);
}

static inline uint32_t pwm_ll_get_cr3_chae(pwm_hw_id_t id)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value = ((reg_value >> PWM_CR3_CHAE_POS) & PWM_CR3_CHAE_MASK);
    return reg_value;
}

static inline void pwm_ll_set_cr3_chbe_value(pwm_hw_id_t id, uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value &= ~(PWM_CR3_CHBE_MASK << PWM_CR3_CHBE_POS);
    reg_value |= ((value & PWM_CR3_CHBE_MASK) << PWM_CR3_CHBE_POS);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR,reg_value);
}

static inline uint32_t pwm_ll_get_cr3_chbe(pwm_hw_id_t id)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value = ((reg_value >> PWM_CR3_CHBE_POS) & PWM_CR3_CHBE_MASK);
    return reg_value;
}

static inline void pwm_ll_set_cr3_chce_value(pwm_hw_id_t id, uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value &= ~(PWM_CR3_CHCE_MASK << PWM_CR3_CHCE_POS);
    reg_value |= ((value & PWM_CR3_CHCE_MASK) << PWM_CR3_CHCE_POS);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR,reg_value);
}

static inline uint32_t pwm_ll_get_cr3_chce(pwm_hw_id_t id)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value = ((reg_value >> PWM_CR3_CHCE_POS) & PWM_CR3_CHCE_MASK);
    return reg_value;
}

static inline void pwm_ll_set_cr3_ccaif_value(pwm_hw_id_t id, uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value &= ~(PWM_CR3_CCAIF_MASK << PWM_CR3_CCAIF_POS);
    reg_value |= ((value & PWM_CR3_CCAIF_MASK) << PWM_CR3_CCAIF_POS);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR,reg_value);
}

static inline uint32_t pwm_ll_get_cr3_ccaif(pwm_hw_id_t id)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value = ((reg_value >> PWM_CR3_CCAIF_POS) & PWM_CR3_CCAIF_MASK);
    return reg_value;
}

static inline void pwm_ll_set_cr3_ccbif_value(pwm_hw_id_t id, uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value &= ~(PWM_CR3_CCBIF_MASK << PWM_CR3_CCBIF_POS);
    reg_value |= ((value & PWM_CR3_CCBIF_MASK) << PWM_CR3_CCBIF_POS);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR,reg_value);
}

static inline uint32_t pwm_ll_get_cr3_ccbif(pwm_hw_id_t id)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value = ((reg_value >> PWM_CR3_CCBIF_POS) & PWM_CR3_CCBIF_MASK);
    return reg_value;
}

static inline void pwm_ll_set_cr3_cccif_value(pwm_hw_id_t id, uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value &= ~(PWM_CR3_CCCIF_MASK << PWM_CR3_CCCIF_POS);
    reg_value |= ((value & PWM_CR3_CCCIF_MASK) << PWM_CR3_CCCIF_POS);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR,reg_value);
}

static inline uint32_t pwm_ll_get_cr3_cccif(pwm_hw_id_t id)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value = ((reg_value >> PWM_CR3_CCCIF_POS) & PWM_CR3_CCCIF_MASK);
    return reg_value;
}

static inline void pwm_ll_set_cr3_cen6_value(pwm_hw_id_t id, uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value &= ~(PWM_CR3_CEN6_MASK << PWM_CR3_CEN6_POS);
    reg_value |= ((value & PWM_CR3_CEN6_MASK) << PWM_CR3_CEN6_POS);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR,reg_value);
}

static inline uint32_t pwm_ll_get_cr3_cen6(pwm_hw_id_t id)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value = ((reg_value >> PWM_CR3_CEN6_POS) & PWM_CR3_CEN6_MASK);
    return reg_value;
}

static inline void pwm_ll_set_cr3_cen5_value(pwm_hw_id_t id, uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value &= ~(PWM_CR3_CEN5_MASK << PWM_CR3_CEN5_POS);
    reg_value |= ((value & PWM_CR3_CEN5_MASK) << PWM_CR3_CEN5_POS);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR,reg_value);
}

static inline uint32_t pwm_ll_get_cr3_cen5(pwm_hw_id_t id)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value = ((reg_value >> PWM_CR3_CEN5_POS) & PWM_CR3_CEN5_MASK);
    return reg_value;
}

static inline void pwm_ll_set_cr3_cen4_value(pwm_hw_id_t id, uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value &= ~(PWM_CR3_CEN4_MASK << PWM_CR3_CEN4_POS);
    reg_value |= ((value & PWM_CR3_CEN4_MASK) << PWM_CR3_CEN4_POS);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR,reg_value);
}

static inline uint32_t pwm_ll_get_cr3_cen4(pwm_hw_id_t id)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_CR3_ADDR);
    reg_value = ((reg_value >> PWM_CR3_CEN4_POS) & PWM_CR3_CEN4_MASK);
    return reg_value;
}

/* REG_0x30 */
#define PWM_TIM4_CNT_ADDR  (0x30*4) //REG ADDR :0x8A00C0
#define PWM_TIM4_CNT_TIM4_CNT_POS (0)
#define PWM_TIM4_CNT_TIM4_CNT_MASK (0xFFFFFFFF)

static inline uint32_t pwm_ll_get_tim4_cnt_value(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_TIM4_CNT_ADDR);
}

static inline uint32_t pwm_ll_get_tim4_cnt_tim4_cnt(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_TIM4_CNT_ADDR);
}

/* REG_0x31 */
#define PWM_TIM5_CNT_ADDR  (0x31*4) //REG ADDR :0x8A00C0
#define PWM_TIM5_CNT_TIM5_CNT_POS (0)
#define PWM_TIM5_CNT_TIM5_CNT_MASK (0xFFFFFFFF)

static inline uint32_t pwm_ll_get_tim5_cnt_value(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_TIM5_CNT_ADDR);
}

static inline uint32_t pwm_ll_get_tim5_cnt_tim5_cnt(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_TIM5_CNT_ADDR);
}

/* REG_0x32 */
#define PWM_TIM6_CNT_ADDR  (0x32*4) //REG ADDR :0x8A00C0
#define PWM_TIM6_CNT_TIM6_CNT_POS (0)
#define PWM_TIM6_CNT_TIM6_CNT_MASK (0xFFFFFFFF)

static inline uint32_t pwm_ll_get_tim6_cnt_value(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_TIM6_CNT_ADDR);
}

static inline uint32_t pwm_ll_get_tim6_cnt_tim6_cnt(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_TIM6_CNT_ADDR);
}

/* REG_0x33 */
#define PWM_PSCR2_ADDR  (0x33*4) //REG ADDR :0x802bbc
#define PWM_PSCR2_PSC4_POS (0)
#define PWM_PSCR2_PSC4_MASK (0xFF)

#define PWM_PSCR2_PSC5_POS (8)
#define PWM_PSCR2_PSC5_MASK (0xFF)

#define PWM_PSCR2_PSC6_POS (16)
#define PWM_PSCR2_PSC6_MASK (0xFF)

static inline void pwm_ll_set_pscr2_psc4_value(pwm_hw_id_t id, uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_PSCR2_ADDR);
    reg_value &= ~(PWM_PSCR2_PSC4_MASK << PWM_PSCR2_PSC4_POS);
    reg_value |= ((value & PWM_PSCR2_PSC4_MASK) << PWM_PSCR2_PSC4_POS);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_PSCR2_ADDR,reg_value);
}

static inline uint32_t pwm_ll_get_pscr2_psc4(pwm_hw_id_t id)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_PSCR2_ADDR);
    reg_value = ((reg_value >> PWM_PSCR2_PSC4_POS) & PWM_PSCR2_PSC4_MASK);
    return reg_value;
}

static inline void pwm_ll_set_pscr2_psc5_value(pwm_hw_id_t id, uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_PSCR2_ADDR);
    reg_value &= ~(PWM_PSCR2_PSC5_MASK << PWM_PSCR2_PSC5_POS);
    reg_value |= ((value & PWM_PSCR2_PSC5_MASK) << PWM_PSCR2_PSC5_POS);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_PSCR2_ADDR,reg_value);
}

static inline uint32_t pwm_ll_get_pscr2_psc5(pwm_hw_id_t id)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_PSCR2_ADDR);
    reg_value = ((reg_value >> PWM_PSCR2_PSC5_POS) & PWM_PSCR2_PSC5_MASK);
    return reg_value;
}

static inline void pwm_ll_set_pscr2_psc6_value(pwm_hw_id_t id, uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_PSCR2_ADDR);
    reg_value &= ~(PWM_PSCR2_PSC6_MASK << PWM_PSCR2_PSC6_POS);
    reg_value |= ((value & PWM_PSCR2_PSC6_MASK) << PWM_PSCR2_PSC6_POS);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_PSCR2_ADDR,reg_value);
}

static inline uint32_t pwm_ll_get_pscr2_psc6(pwm_hw_id_t id)
{
    uint32_t reg_value;
    reg_value = REG_READ(PWM_LL_REG_BASE(id) + PWM_PSCR2_ADDR);
    reg_value = ((reg_value >> PWM_PSCR2_PSC6_POS) & PWM_PSCR2_PSC6_MASK);
    return reg_value;
}

/* REG_0x34 */
#define PWM_TIM4_ARR_ADDR  (0x34*4) //REG ADDR :0x8A00C0
#define PWM_TIM4_ARR_TIM4_ARR_POS (0)
#define PWM_TIM4_ARR_TIM4_ARR_MASK (0xFFFFFFFF)

static inline uint32_t pwm_ll_get_tim4_arr_value(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_TIM4_ARR_ADDR);
}

static inline void pwm_ll_set_tim4_arr_value(pwm_hw_id_t id, uint32_t value)
{
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_TIM4_ARR_ADDR,value);
}

static inline uint32_t pwm_ll_get_tim4_arr_tim4_arr(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_TIM4_ARR_ADDR);
}

static inline void pwm_ll_set_tim4_arr_tim4_arr(pwm_hw_id_t id, uint32_t value)
{
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_TIM4_ARR_ADDR,value);
}

/* REG_0x35 */
#define PWM_TIM5_ARR_ADDR  (0x35*4) //REG ADDR :0x8A00C0
#define PWM_TIM5_ARR_TIM5_ARR_POS (0)
#define PWM_TIM5_ARR_TIM5_ARR_MASK (0xFFFFFFFF)

static inline uint32_t pwm_ll_get_tim5_arr_value(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_TIM5_ARR_ADDR);
}

static inline void pwm_ll_set_tim5_arr_value(pwm_hw_id_t id, uint32_t value)
{
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_TIM5_ARR_ADDR,value);
}

static inline uint32_t pwm_ll_get_tim5_arr_tim5_arr(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_TIM5_ARR_ADDR);
}

static inline void pwm_ll_set_tim5_arr_tim5_arr(pwm_hw_id_t id, uint32_t value)
{
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_TIM5_ARR_ADDR,value);
}

/* REG_0x36 */
#define PWM_TIM6_ARR_ADDR  (0x36*4) //REG ADDR :0x8A00C0
#define PWM_TIM6_ARR_TIM6_ARR_POS (0)
#define PWM_TIM6_ARR_TIM6_ARR_MASK (0xFFFFFFFF)

static inline uint32_t pwm_ll_get_tim6_arr_value(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_TIM6_ARR_ADDR);
}

static inline void pwm_ll_set_tim6_arr_value(pwm_hw_id_t id, uint32_t value)
{
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_TIM6_ARR_ADDR,value);
}

static inline uint32_t pwm_ll_get_tim6_arr_tim6_arr(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_TIM6_ARR_ADDR);
}

static inline void pwm_ll_set_tim6_arr_tim6_arr(pwm_hw_id_t id, uint32_t value)
{
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_TIM6_ARR_ADDR,value);
}

/* REG_0x37 */
#define PWM_CCRA_ADDR  (0x37*4) //REG ADDR :0x8A00C0
#define PWM_CCRA_CCRA_POS (0)
#define PWM_CCRA_CCRA_MASK (0xFFFFFFFF)

static inline uint32_t pwm_ll_get_ccra_value(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_CCRA_ADDR);
}

static inline void pwm_ll_set_ccra_value(pwm_hw_id_t id, uint32_t value)
{
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CCRA_ADDR,value);
}

static inline uint32_t pwm_ll_get_ccra_ccra(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_CCRA_ADDR);
}

static inline void pwm_ll_set_ccra_ccra(pwm_hw_id_t id, uint32_t value)
{
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CCRA_ADDR,value);
}

/* REG_0x38 */
#define PWM_CCRB_ADDR  (0x38*4) //REG ADDR :0x8A00C0
#define PWM_CCRB_CCRB_POS (0)
#define PWM_CCRB_CCRB_MASK (0xFFFFFFFF)

static inline uint32_t pwm_ll_get_ccrb_value(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_CCRB_ADDR);
}

static inline void pwm_ll_set_ccrb_value(pwm_hw_id_t id, uint32_t value)
{
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CCRB_ADDR,value);
}

static inline uint32_t pwm_ll_get_ccrb_ccrb(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_CCRB_ADDR);
}

static inline void pwm_ll_set_ccrb_ccrb(pwm_hw_id_t id, uint32_t value)
{
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CCRB_ADDR,value);
}

/* REG_0x39 */
#define PWM_CCRC_ADDR  (0x39*4) //REG ADDR :0x8A00C0
#define PWM_CCRC_CCRC_POS (0)
#define PWM_CCRC_CCRC_MASK (0xFFFFFFFF)

static inline uint32_t pwm_ll_get_ccrc_value(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_CCRC_ADDR);
}

static inline void pwm_ll_set_ccrc_value(pwm_hw_id_t id, uint32_t value)
{
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CCRC_ADDR,value);
}

static inline uint32_t pwm_ll_get_ccrc_ccrc(pwm_hw_id_t id)
{
    return REG_READ(PWM_LL_REG_BASE(id) + PWM_CCRC_ADDR);
}

static inline void pwm_ll_set_ccrc_ccrc(pwm_hw_id_t id, uint32_t value)
{
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CCRC_ADDR,value);
}

#if (CONFIG_PWM_PM_CB_SUPPORT)
#define PWM_PM_BACKUP_REG_NUM    (17)

static inline void pwm_ll_pm_backup(pwm_hw_id_t id, uint32_t *pm_backup)
{
    pm_backup[0] = REG_READ(PWM_LL_REG_BASE(id) + PWM_CG_RESET_ADDR);
    pm_backup[1] = REG_READ(PWM_LL_REG_BASE(id) + PWM_PWM_CR1_ADDR);
    pm_backup[2] = REG_READ(PWM_LL_REG_BASE(id) + PWM_PWM_DIER_ADDR);
    pm_backup[3] = REG_READ(PWM_LL_REG_BASE(id) + PWM_PWM_CCMR_ADDR);
    pm_backup[4] = REG_READ(PWM_LL_REG_BASE(id) + PWM_PRESCALER_ADDR);
    pm_backup[5] = REG_READ(PWM_LL_REG_BASE(id) + PWM_TIM1_ARR_ADDR);
    pm_backup[6] = REG_READ(PWM_LL_REG_BASE(id) + PWM_TIM2_ARR_ADDR);
    pm_backup[7] = REG_READ(PWM_LL_REG_BASE(id) + PWM_TIM3_ARR_ADDR);

    pm_backup[8] = REG_READ(PWM_LL_REG_BASE(id) + PWM_CCR1_ADDR);
    pm_backup[9] = REG_READ(PWM_LL_REG_BASE(id) + PWM_CCR2_ADDR);
    pm_backup[10] = REG_READ(PWM_LL_REG_BASE(id) + PWM_CCR3_ADDR);

    pm_backup[11] = REG_READ(PWM_LL_REG_BASE(id) + PWM_CCR4_ADDR);
    pm_backup[12] = REG_READ(PWM_LL_REG_BASE(id) + PWM_CCR5_ADDR);
    pm_backup[13] = REG_READ(PWM_LL_REG_BASE(id) + PWM_CCR6_ADDR);

    pm_backup[14] = REG_READ(PWM_LL_REG_BASE(id) + PWM_CCR7_ADDR);
    pm_backup[15] = REG_READ(PWM_LL_REG_BASE(id) + PWM_CCR8_ADDR);
    pm_backup[16] = REG_READ(PWM_LL_REG_BASE(id) + PWM_CCR9_ADDR);
}

static inline void pwm_ll_pm_restore(pwm_hw_id_t id, uint32_t *pm_backup)
{
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CG_RESET_ADDR, pm_backup[0]);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_PWM_DIER_ADDR, pm_backup[2]);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_PWM_CCMR_ADDR, pm_backup[3]);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_PRESCALER_ADDR, pm_backup[4]);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_TIM1_ARR_ADDR, pm_backup[5]);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_TIM2_ARR_ADDR, pm_backup[6]);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_TIM3_ARR_ADDR, pm_backup[7]);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CCR1_ADDR, pm_backup[8]);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CCR2_ADDR, pm_backup[9]);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CCR3_ADDR, pm_backup[10]);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CCR4_ADDR, pm_backup[11]);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CCR5_ADDR, pm_backup[12]);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CCR6_ADDR, pm_backup[13]);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CCR7_ADDR, pm_backup[14]);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CCR8_ADDR, pm_backup[15]);
    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_CCR9_ADDR, pm_backup[16]);

    REG_WRITE(PWM_LL_REG_BASE(id) + PWM_PWM_CR1_ADDR, pm_backup[1]);
}
#endif
