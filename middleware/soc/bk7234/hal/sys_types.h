...
#define LOW_POWER_DPLL_STABILITY_DELAY_TIME                 (0.29) // 0.29ms(hardware need at least 180us,because making the precise it use 290us,it will additional add 6us or 2us(external) )
