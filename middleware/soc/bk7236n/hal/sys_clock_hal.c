...
void sys_hal_clk_pin_ana_open(clk_pin_ana_src_t src, clk_pin_div_t div, bool en)
{
    ...
    case CLK_PIN_ANA_ROSC:
        sys_ll_set_ana_reg5_cktst_sel(0x0);
        sys_ll_set_ana_reg5_ck_tst_enable(en);
        sys_ll_set_ana_reg5_rosc_tsten(en);
        break;

    case CLK_PIN_ANA_XTAL:
        sys_ll_set_ana_reg5_en_xtall(1);
        sys_ll_set_ana_reg5_cktst_sel(0x1);
        sys_ll_set_ana_reg5_ck_tst_enable(en);
        sys_ll_set_ana_reg5_xtall_ten(en);
        break;

    case CLK_PIN_ANA_DPLL:
        sys_ll_set_ana_reg5_cktst_sel(0x3);
        sys_ll_set_ana_reg5_ck_tst_enable(en);
        sys_ll_set_ana_reg0_dpll_tsten(en);
        break;
...
void sys_hal_clk_pin_dig_open(clk_pin_dig_src_t src, clk_pin_div_t div, bool en)
{
    ...
    case CLK_PIN_DIG_LPO_CLK_XTALL:
        sys_ll_set_ana_reg5_en_xtall(en);
