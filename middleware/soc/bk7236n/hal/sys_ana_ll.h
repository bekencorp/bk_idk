...
static inline void sys_ana_ll_set_ana_reg5_nc_3_3(uint32_t v) {
	sys_ana_set_ana_reg_bit((SOC_SYS_ANA_REG_BASE + (0x45 << 2)), 3, 0x1, v);
}

static inline uint32_t sys_ana_ll_get_ana_reg5_nc_3_3(void) {
	sys_ana_ana_reg5_t *r = (sys_ana_ana_reg5_t*)(SOC_SYS_ANA_REG_BASE + (0x45 << 2));
	return r->nc_3_3;
}
...
static inline void sys_ana_ll_set_ana_reg8_nc_24_24(uint32_t v) {
	sys_ana_set_ana_reg_bit((SOC_SYS_ANA_REG_BASE + (0x48 << 2)), 24, 0x1, v);
}

static inline uint32_t sys_ana_ll_get_ana_reg8_nc_24_24(void) {
	sys_ana_ana_reg8_t *r = (sys_ana_ana_reg8_t*)(SOC_SYS_ANA_REG_BASE + (0x48 << 2));
	return r->nc_24_24;
}
