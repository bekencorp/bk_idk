...
/***********************************************************************************************************************************
* This file is generated from BK7286_ADDR_Mapping_s.xlsm automatically
* Modify it manually is not recommended
* CHIP ID:BK7286,GENARATE TIME:2022-12-13 16:01:16
************************************************************************************************************************************/
...
#define JPEG_DEC_REG0XF_MCU_BLK_MASK (0xFFFF) 

#define JPEG_DEC_REG0XF_RESERVED_POS (16) 
#define JPEG_DEC_REG0XF_RESERVED_MASK (0xFFFF) 
...
#define JPEG_DEC_REG0X50_RESERVED_MASK (0xFFFFFF) 

#define JPEG_DEC_REG0X50_OUT_FMT_POS (26) 
#define JPEG_DEC_REG0X50_OUT_FMT_MASK (0x3) 

#define JPEG_DEC_REG0X50_FFD9_CHECK_POS (28) 
#define JPEG_DEC_REG0X50_FFD9_CHECK_MASK (0x1) 
...
/* REG_0x50:reg0x50->out_fmt:0x50[27:26],00: y0uy1v; 01: vuy1y0; 02: vy1uy0; 03: y0y1uv,0x0,R/W*/
static inline uint32_t jpeg_dec_ll_get_reg0x50_out_fmt(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(JPEG_DEC_REG0X50_ADDR);
    reg_value = ((reg_value >> JPEG_DEC_REG0X50_OUT_FMT_POS) & JPEG_DEC_REG0X50_OUT_FMT_MASK);
    return reg_value;
}

static inline void jpeg_dec_ll_set_reg0x50_out_fmt(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(JPEG_DEC_REG0X50_ADDR);
    reg_value &= ~(JPEG_DEC_REG0X50_OUT_FMT_MASK << JPEG_DEC_REG0X50_OUT_FMT_POS);
    reg_value |= ((value & JPEG_DEC_REG0X50_OUT_FMT_MASK) << JPEG_DEC_REG0X50_OUT_FMT_POS);
    REG_WRITE(JPEG_DEC_REG0X50_ADDR,reg_value);
}

/* REG_0x50:reg0x50->ffd9_check:0x50[28],enable ffdc check,0x0,R/W*/
static inline uint32_t jpeg_dec_ll_get_reg0x50_ffd9_check(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(JPEG_DEC_REG0X50_ADDR);
    reg_value = ((reg_value >> JPEG_DEC_REG0X50_FFD9_CHECK_POS) & JPEG_DEC_REG0X50_FFD9_CHECK_MASK);
    return reg_value;
}

static inline void jpeg_dec_ll_set_reg0x50_ffd9_check(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(JPEG_DEC_REG0X50_ADDR);
    reg_value &= ~(JPEG_DEC_REG0X50_FFD9_CHECK_MASK << JPEG_DEC_REG0X50_FFD9_CHECK_POS);
    reg_value |= ((value & JPEG_DEC_REG0X50_FFD9_CHECK_MASK) << JPEG_DEC_REG0X50_FFD9_CHECK_POS);
    REG_WRITE(JPEG_DEC_REG0X50_ADDR,reg_value);
}
...
#define JPEG_DEC_REG0X52_RESERVED1_POS (2) 
#define JPEG_DEC_REG0X52_RESERVED1_MASK (0x3F) 

#define JPEG_DEC_REG0X52_JPEG_LINE_NUM_POS (8)
#define JPEG_DEC_REG0X52_JPEG_LINE_NUM_MASK (0x1FFF)

#define JPEG_DEC_REG0X52_RESERVED0_POS (21) 
#define JPEG_DEC_REG0X52_RESERVED0_MASK (0x7FF) 
...
#define JPEG_DEC_REG0X5E_DEC_HUF_ERR_INT_POS (9)
#define JPEG_DEC_REG0X5E_DEC_HUF_ERR_INT_MASK (0x1)


#define JPEG_DEC_REG0X5E_DEC_RUN2LONG_INT_POS (10)
#define JPEG_DEC_REG0X5E_DEC_RUN2LONG_INT_MASK (0x1)

#define JPEG_DEC_REG0X5E_DEC_FFD9_INT_POS (11)
#define JPEG_DEC_REG0X5E_DEC_FFD9_INT_MASK (0x1)

#define JPEG_DEC_REG0X5E_RESERVED_POS (12)
#define JPEG_DEC_REG0X5E_RESERVED_MASK (0xFFFFF)
...
/* REG_0x5e:reg0x5e->dec_huf_err_int:0x5e[9], ,0x0,R/W*/
static inline uint32_t jpeg_dec_ll_get_reg0x5e_dec_huf_err_int(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(JPEG_DEC_REG0X5E_ADDR);
    reg_value = ((reg_value >> JPEG_DEC_REG0X5E_DEC_HUF_ERR_INT_POS) & JPEG_DEC_REG0X5E_DEC_HUF_ERR_INT_MASK);
    return reg_value;
}

static inline void jpeg_dec_ll_set_reg0x5e_dec_huf_err_int(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(JPEG_DEC_REG0X5E_ADDR);
    reg_value &= ~(JPEG_DEC_REG0X5E_DEC_HUF_ERR_INT_MASK << JPEG_DEC_REG0X5E_DEC_HUF_ERR_INT_POS);
    reg_value |= ((value & JPEG_DEC_REG0X5E_DEC_HUF_ERR_INT_MASK) << JPEG_DEC_REG0X5E_DEC_HUF_ERR_INT_POS);
    REG_WRITE(JPEG_DEC_REG0X5E_ADDR,reg_value);
}

/* REG_0x5e:reg0x5e->dec_run2long_int:0x5e[10], ,0x0,R/W*/
static inline uint32_t jpeg_dec_ll_get_reg0x5e_dec_run2long_int(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(JPEG_DEC_REG0X5E_ADDR);
    reg_value = ((reg_value >> JPEG_DEC_REG0X5E_DEC_RUN2LONG_INT_POS) & JPEG_DEC_REG0X5E_DEC_RUN2LONG_INT_MASK);
    return reg_value;
}

static inline void jpeg_dec_ll_set_reg0x5e_dec_run2long_int(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(JPEG_DEC_REG0X5E_ADDR);
    reg_value &= ~(JPEG_DEC_REG0X5E_DEC_RUN2LONG_INT_MASK << JPEG_DEC_REG0X5E_DEC_RUN2LONG_INT_POS);
    reg_value |= ((value & JPEG_DEC_REG0X5E_DEC_RUN2LONG_INT_MASK) << JPEG_DEC_REG0X5E_DEC_RUN2LONG_INT_POS);
    REG_WRITE(JPEG_DEC_REG0X5E_ADDR,reg_value);
}

/* REG_0x5e:reg0x5e->dec_ffd9_int:0x5e[11],int enable; ,0x0,R/W*/
static inline uint32_t jpeg_dec_ll_get_reg0x5e_dec_ffd9_int(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(JPEG_DEC_REG0X5E_ADDR);
    reg_value = ((reg_value >> JPEG_DEC_REG0X5E_DEC_FFD9_INT_POS) & JPEG_DEC_REG0X5E_DEC_FFD9_INT_MASK);
    return reg_value;
}

static inline void jpeg_dec_ll_set_reg0x5e_dec_ffd9_int(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(JPEG_DEC_REG0X5E_ADDR);
    reg_value &= ~(JPEG_DEC_REG0X5E_DEC_FFD9_INT_MASK << JPEG_DEC_REG0X5E_DEC_FFD9_INT_POS);
    reg_value |= ((value & JPEG_DEC_REG0X5E_DEC_FFD9_INT_MASK) << JPEG_DEC_REG0X5E_DEC_FFD9_INT_POS);
    REG_WRITE(JPEG_DEC_REG0X5E_ADDR,reg_value);
}
...
#define JPEG_DEC_REG0X5F_DEC_HUF_ERR_INT_CLR_POS (9) 
#define JPEG_DEC_REG0X5F_DEC_HUF_ERR_INT_CLR_MASK (0x1) 

#define JPEG_DEC_REG0X5F_DEC_RUN2LONG_INT_CLR_POS (10) 
#define JPEG_DEC_REG0X5F_DEC_RUN2LONG_INT_CLR_MASK (0x1) 

#define JPEG_DEC_REG0X5F_DEC_FFD9_INT_CLR_POS (11) 
#define JPEG_DEC_REG0X5F_DEC_FFD9_INT_CLR_MASK (0x1) 

#define JPEG_DEC_REG0X5F_RESERVED0_POS (12) 
#define JPEG_DEC_REG0X5F_RESERVED0_MASK (0xFFFFF) 
...
/* REG_0x5f:reg0x5f->dec_huf_err_int_clr:0x5f[9], ,0x0,R/W*/
static inline uint32_t jpeg_dec_ll_get_reg0x5f_dec_huf_err_int_clr(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(JPEG_DEC_REG0X5F_ADDR);
    reg_value = ((reg_value >> JPEG_DEC_REG0X5F_DEC_HUF_ERR_INT_CLR_POS) & JPEG_DEC_REG0X5F_DEC_HUF_ERR_INT_CLR_MASK);
    return reg_value;
}

static inline void jpeg_dec_ll_set_reg0x5f_dec_huf_err_int_clr(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(JPEG_DEC_REG0X5F_ADDR);
    reg_value &= ~(JPEG_DEC_REG0X5F_DEC_HUF_ERR_INT_CLR_MASK << JPEG_DEC_REG0X5F_DEC_HUF_ERR_INT_CLR_POS);
    reg_value |= ((value & JPEG_DEC_REG0X5F_DEC_HUF_ERR_INT_CLR_MASK) << JPEG_DEC_REG0X5F_DEC_HUF_ERR_INT_CLR_POS);
    REG_WRITE(JPEG_DEC_REG0X5F_ADDR,reg_value);
}

/* REG_0x5f:reg0x5f->dec_run2long_int_clr:0x5f[10], ,0x0,R/W*/
static inline uint32_t jpeg_dec_ll_get_reg0x5f_dec_run2long_int_clr(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(JPEG_DEC_REG0X5F_ADDR);
    reg_value = ((reg_value >> JPEG_DEC_REG0X5F_DEC_RUN2LONG_INT_CLR_POS) & JPEG_DEC_REG0X5F_DEC_RUN2LONG_INT_CLR_MASK);
    return reg_value;
}

static inline void jpeg_dec_ll_set_reg0x5f_dec_run2long_int_clr(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(JPEG_DEC_REG0X5F_ADDR);
    reg_value &= ~(JPEG_DEC_REG0X5F_DEC_RUN2LONG_INT_CLR_MASK << JPEG_DEC_REG0X5F_DEC_RUN2LONG_INT_CLR_POS);
    reg_value |= ((value & JPEG_DEC_REG0X5F_DEC_RUN2LONG_INT_CLR_MASK) << JPEG_DEC_REG0X5F_DEC_RUN2LONG_INT_CLR_POS);
    REG_WRITE(JPEG_DEC_REG0X5F_ADDR,reg_value);
}

/* REG_0x5f:reg0x5f->dec_ffd9_int_clr:0x5f[11],int status,  write 1 clear; ,0x0,R/W*/
static inline uint32_t jpeg_dec_ll_get_reg0x5f_dec_ffd9_int_clr(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(JPEG_DEC_REG0X5F_ADDR);
    reg_value = ((reg_value >> JPEG_DEC_REG0X5F_DEC_FFD9_INT_CLR_POS) & JPEG_DEC_REG0X5F_DEC_FFD9_INT_CLR_MASK);
    return reg_value;
}

static inline void jpeg_dec_ll_set_reg0x5f_dec_ffd9_int_clr(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(JPEG_DEC_REG0X5F_ADDR);
    reg_value &= ~(JPEG_DEC_REG0X5F_DEC_FFD9_INT_CLR_MASK << JPEG_DEC_REG0X5F_DEC_FFD9_INT_CLR_POS);
    reg_value |= ((value & JPEG_DEC_REG0X5F_DEC_FFD9_INT_CLR_MASK) << JPEG_DEC_REG0X5F_DEC_FFD9_INT_CLR_POS);
    REG_WRITE(JPEG_DEC_REG0X5F_ADDR,reg_value);
}
