...
typedef volatile struct {
	...
	union {
		struct {
			uint32_t int_vsync_nege_mask:     2; /**< bit[0:1] */
			uint32_t int_resl_err_mask:       1; /**< bit[2] */
			uint32_t int_sens_full_mask:      1; /**< bit[3] */
			uint32_t int_enc_slow_mask:       1; /**< bit[4] */
			uint32_t int_h264_err_mask:       1; /**< bit[5] */
	...
	/* REG_0xc */
	uint32_t emr_base_addr;

	/* REG_0xd */
	union {
		struct {
			uint32_t bps_pingpong:            1; /**< bit[0] */
			uint32_t x_pixel_resize:          8; /**< bit[1:8] */
			uint32_t y_pixel_resize:          8; /**< bit[9:16] */
