...
#define addRESIZE0_Reg0x06            *((volatile unsigned long *) SCALE0_0X06_ADDR)
#define setf_RESIZE0_col_coef(val)     addRESIZE0_Reg0x06 = (addRESIZE0_Reg0x06 & ~(0xffffffff)) | (val<<0)
...
#define SCALE0_0X0F_CLR_INT_STAT_MASK (0x7) 
